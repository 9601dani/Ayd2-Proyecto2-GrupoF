...
public class CaseServiceTest {
    ...
    @Test
    public void updateCaseSuccessfullyWithoutTypeChange() throws CaseException {
        when(caseRepository.findById(ID)).thenReturn(Optional.of(testCase));
        when(caseRepository.save(any())).thenReturn(testCase);
    ...
    @Test
    public void updateCaseSuccessfullyWithTypeChange() throws CaseException {
    ...
    @Test
    public void cancelCaseSuccessfully() throws CaseException {
